...
import 'package:giftty/Model/Notification_Model.dart';
...
class StateNoti extends State<NotificationList> with TickerProviderStateMixin {
            ...
            child: BlocBuilder<NotificationBloc, NotificationState>(
              builder: (context, state) {
                if (state is NotificationInitial) {
                  ...
                  // return notification(state.articles);
                  // setState(() {
                  notiList = state.articles;
                  // });
                  print('gyug uygfguygyhghhhhhhhhhhhhhhhhhhhhhhh${state.articles.length}');
                  return ListView.builder(
                    ...
                    itemBuilder: (context,index) {
                      print(index);
                      return (index == state.articles.length && isLoadingmore)
  ...
  // Widget notification(List<Notification_Model> notiList){
  //   print('gyug uygfguygyhghhhhhhhhhhhhhhhhhhhhhhh${notiList.length}');
  //   return ListView.builder(
  //     shrinkWrap: true,
  //     controller: controller,
