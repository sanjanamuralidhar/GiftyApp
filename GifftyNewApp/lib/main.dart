...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    imageBloc = ImageBloc(repository: Api());
    notificationBloc = NotificationBloc(repository: Api());
    favoriteBloc = FavoriteBloc(repository: Api());
    productDetailBloc = ProductDetailBloc(repository: Api());
    favoriteCrudBloc = FavoriteCrudBloc(repository: Api());
    sampleBloc = FavBloc(repository: Api());
    productListBloc = ProductListBloc(repository: Api());
    super.initState();
  }
  ...
  // ignore: unused_local_variable
        ...
        BlocProvider<SliderBloc>(
          create: (context) => sliderBloc,
					...
					BlocProvider<FavoriteCrudBloc>(
						create: (context) => favoriteCrudBloc,
					),
