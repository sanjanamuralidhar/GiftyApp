...
class StateHome extends State<Home> {
  ...
  void initState() {
    ...
    imageBloc.add(FetchImageEvent());
    initDynamicLinks();
    home = new HomePage(updateHome,categoryBloc,sliderBloc,sectionBloc,imageBloc);
    fragments = [
      HomePage(updateHome,categoryBloc,sliderBloc,sectionBloc,imageBloc),
      Favorite(updateHome),
      NotificationList(),
...
class HomePage extends StatefulWidget {
  ...
  HomePage(this.updateHome, this.categoryBloc, this.sliderBloc, this.sectionBloc, this.imageBloc);
...
////////////////////////////////////////////////////////////////// BannerBloc /////////////////////////////////
  ...
  //////////////////////////////////////////invalied value range problem//////////SectionBloc//////////////////////////
        ...
        child: BlocBuilder<ImageBloc, ImageState>(
          builder: (context, state) {
            if (state is ImageInitialState) {
              ...
              print(state.articles[0].name);
              offerImages = state.articles;
              print('bibdifcb fhdhcdc dufhcvud dhfcvofhv${offerImages.length}');
...
//////////////////////// Section /////////////////
  ...
  _getOfferImage(index) {
    print('bibdifcb fhdhcdc dufhcvud dhfcvofhv sdcvsdfv fdvdf${offerImages.length}');
    return InkWell(
      child: FadeInImage(
          fadeInDuration: Duration(milliseconds: 150),
...
////////////////////////////// Section list ////////////////////
  ...
  Future<dynamic> getPages(dynamic articles) async {
    // pages = homeSliderList.map((articles) {
    //   return _buildImagePageItem(articles);
    // }).toList();
    //changed on 20-4-21 below is old
    pages = homeSliderList.map((slides) {
      return _buildImagePageItem(slides);
    }).toList();
  }
